...
public class DeviceScanActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent.putExtra(MainActivity.EXTRAS_DEVICE_NAME, device.getName());//send device name to next activity
        intent.putExtra(MainActivity.EXTRAS_DEVICE_ADDRESS, device.getAddress());//send device address to next activity
        if (mScanning) {
            mBluetoothAdapter.stopLeScan(mLeScanCallback);
            mScanning = false;
        }
